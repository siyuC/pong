...
class ActorNetwork(object):
    ...
    def create_actor_network(self): 
        inputs = tflearn.input_data(shape=[None, 80, 80, 1]) 
...
#   Agent Training
# ===========================
def train(sess, env, actor, critic, action_dim):
    ...
    # actor.model.load('actor_model.tflearn')
    # actor.target_model.load('actor_target_model.tflearn')
    # critic.model.load('critic_model.tflearn')
    # critic.target_model.load('critic_target_model.tflearn')
    ...
    while 1:
        ...
        # if i % 1 == 0:
        #     saver.save(sess, 'ddpg_pong/', global_step = i)
...
def main(_):
    with tf.Session() as sess:
        ...
        action_dim = env.action_space.n # discrete 6
        ...
        train(sess, env, actor, critic, action_dim)
