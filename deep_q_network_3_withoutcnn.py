...
def createNetwork():
    ...
    W_fc1 = weight_variable([3200, 512])
    ...
    h_conv3_flat = tf.reshape(h_pool1, [-1, 3200])
...
def trainNetwork(s, readout, h_fc1, sess):
    ...
    checkpoint = tf.train.get_checkpoint_state("dqn_pong_withoutcnn")
    ...
    while 1:
        ...
        if t % 10000 == 0:
            saver.save(sess, 'dqn_pong_withoutcnn/', global_step = t)
        # print info
        if (t % 1000 == 0):
